...
func TestKvString2Map(x *testing.T) {
    var (
    ...
    s := "1=foo,2=bar,3=baz"
    fmt.Println(decodeKvString2Map(s, &m0), m0) // pass
    fmt.Println(decodeKvString2Map(s, &m1), m1) // pass
    fmt.Println(decodeKvString2Map(s, &m2), m2) // pass
    fmt.Println(decodeKvString2Map(s, &m3), m3) // pass
    fmt.Println(decodeKvString2Map(s, &m4), m4) // fail
}

func decodeKvString2Map(s string, i interface{}) error {
    v := reflect.ValueOf(i)
