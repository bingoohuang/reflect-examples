...
func TestFormatVal(t *testing.T) {
	...
	if nil == Validate(struct {
		field int `validate:"enum="`
	}{
		field: 0,
	}) {
		t.Errorf("empty enum validate should not validate")
	}
...
func TestOneOfValForDuration(t *testing.T) {
	if nil == Validate(struct {
		field time.Duration `validate:"enum="`
	}{
		field: 4 * time.Second,
	}) {
		t.Errorf("enum validator does not validate for time.Duration")
	}

	if nil == Validate(struct {
		field time.Duration `validate:"enum=abc"`
	}{
		field: 4 * time.Second,
	}) {
		t.Errorf("enum validator does not validate for time.Duration")
	...
	if nil == Validate(struct {
		field time.Duration `validate:"enum=1s,2s,3s"`
	}{
		field: 4 * time.Second,
	}) {
		t.Errorf("enum validator does not validate for time.Duration")
...
func TestOneOfValForInt(t *testing.T) {
	if nil == Validate(struct {
		...
		t.Errorf("enum validator does not validate for int")
	}

	if nil == Validate(struct {
		field int `validate:"enum=abc"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for int")
	...
	if nil == Validate(struct {
		field int8 `validate:"enum=1,2,3"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for int8")
	}
	...
	if nil == Validate(struct {
		field int16 `validate:"enum=1,2,3"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for int16")
	}
	...
	if nil == Validate(struct {
		field int32 `validate:"enum=1,2,3"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for int32")
	}
	...
	if nil == Validate(struct {
		field int64 `validate:"enum=1,2,3"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for int64")
	}
...
func TestOneOfValForUint(t *testing.T) {
	if nil == Validate(struct {
		field uint `validate:"enum="`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for uint")
	}

	if nil == Validate(struct {
		field uint `validate:"enum=abc"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for uint")
	...
	if nil == Validate(struct {
		field uint `validate:"enum=1,2,3"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for uint")
	...
	if nil == Validate(struct {
		field uint8 `validate:"enum=1,2,3"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for uint8")
	}
	...
	if nil == Validate(struct {
		field uint16 `validate:"enum=1,2,3"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for uint16")
	}
	...
	if nil == Validate(struct {
		field uint32 `validate:"enum=1,2,3"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for uint32")
	}
	...
	if nil == Validate(struct {
		field uint64 `validate:"enum=1,2,3"`
	}{
		field: 4,
	}) {
		t.Errorf("enum validator does not validate for uint64")
	}
...
func TestOneOfValForFloat(t *testing.T) {
	if nil == Validate(struct {
		field float32 `validate:"enum="`
	}{
		field: 4.0,
	}) {
		t.Errorf("enum validator does not validate for float32")
	}

	if nil == Validate(struct {
		field float32 `validate:"enum=abc"`
	}{
		field: 4.0,
	}) {
		t.Errorf("enum validator does not validate for float32")
	...
	if nil == Validate(struct {
		field float32 `validate:"enum=1.0,2.0,3.0"`
	}{
		field: 4.0,
	}) {
		t.Errorf("enum validator does not validate for float32")
	...
	if nil == Validate(struct {
		field float64 `validate:"enum=1.0,2.0,3.0"`
	}{
		field: 4.0,
	}) {
		t.Errorf("enum validator does not validate for float64")
	}
...
func TestOneOfValForString(t *testing.T) {
	if nil == Validate(struct {
		field string `validate:"enum="`
	}{
		field: "four",
	}) {
		t.Errorf("enum validator does not validate for string")
	}

	if nil == Validate(struct {
		field string `validate:"enum=one,two,three"`
	}{
		field: "four",
	}) {
		t.Errorf("enum validator does not validate for string")
...
func TestDeepValsForStruct(t *testing.T) {
	...
	if nil == Validate(struct {
		...
		t.Errorf("enum validator does not validate for struct field")
	}
...
func TestDeepValsForMapKeys(t *testing.T) {
	...
	if nil == Validate(struct {
		field map[int]int `validate:"[enum=1,2,3]"`
	}{
		field: map[int]int{
			4: 0,
		},
	}) {
		t.Errorf("[enum] validator does not validate for map key")
	}
...
func TestDeepValsForMapValues(t *testing.T) {
	...
	if nil == Validate(struct {
		...
		t.Errorf(">enum validator does not validate for map values")
	}
...
func TestDeepValsForSlice(t *testing.T) {
	...
	if nil == Validate(struct {
		...
		t.Errorf(">enum validator does not validate for slice")
	}
...
func TestDeepValsForArray(t *testing.T) {
	...
	if nil == Validate(struct {
		field [1]int `validate:">enum=1,2,3"`
	}{
		field: [1]int{4},
	}) {
		t.Errorf(">enum validator does not validate for array")
	}

	if nil != Validate(struct {
		field [3]int `validate:">enum=1,2,3"`
	}{
		field: [3]int{1, 2, 3},
	}) {
		t.Errorf(">enum validator does not validate for array")
...
func TestDeepValsForPtr(t *testing.T) {
	...
	if nil == Validate(struct {
		...
		t.Errorf(">enum validator does not validate for pointer")
	}
